...
public class ExpandeableCategoryListAdapter extends BaseExpandableListAdapter
{
    private Context mContext;
    private ArrayList<String> mCategoryList; //List of categories
    private HashMap<String, ArrayList<String>> mPhraseList;

    public ExpandeableCategoryListAdapter(Context context, ArrayList<String> categoryList, HashMap<String, ArrayList<String>> phraseList)
    {
        mContext = context;
